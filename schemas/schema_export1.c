...
/*
*       Variable que el esquema va a compartir (exportar) al censo
*
*/
int shared = -2;

/*
*       Variable que el esquema va a pedir (importar) del censo
*
*/
int *shared_externo;
...
*/
G_MODULE_EXPORT gchar* schema_id = "schema_export1";
...
gboolean schema_iteration(gpointer data) {
   static int i = 0;
   g_print("Iteracion %d de %s. En interval tenemos: %d. Variable externa = %d\n", ++i, schema_id, schema_interval, *shared_externo);
   return TRUE;
}
